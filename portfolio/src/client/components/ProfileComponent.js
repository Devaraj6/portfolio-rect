                ...
                <div className={'dashboard-profile-div'}>
                    <div className={'dashboard-profile-img-container'}>
                        ...
                        <div className={'social-profile-container'}>
                            ...
                            <a href="https://www.linkedin.com" target="_blank"><img src={linkedin} className={'social-profile-icon'} /></a>
                    ...
                    <div className={'dashboard-profile-details-container'}>
                        <p className={'dashboard-profile-name-label'}>Hello, I'm <span className={'dashboard-profile-name'}>Devaraj S</span></p>
